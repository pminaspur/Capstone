...
public class MyTrackingAppDBHelper extends SQLiteOpenHelper {
    ...
    private static final class AccountTable {
        //declared variables for the account table
        private static final String TABLE = "account";
        private static final String COL_ID = "_id";
        private static final String COL_USERNAME = "username";
        private static final String COL_EMAILADDRESS = "emailaddress";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + AccountTable.TABLE + " (" +
                ...
                AccountTable.COL_EMAILADDRESS + " text, " +
                AccountTable.COL_AGE + " text, " +
                AccountTable.COL_HEIGHT + " text)");
    ...
    // user adding the Account details
    public long addAccount(String userName, String emailAddress, String age, String height) {
        SQLiteDatabase db = getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(AccountTable.COL_USERNAME, userName);
        values.put(AccountTable.COL_USERNAME,emailAddress);
        values.put(AccountTable.COL_AGE,age);
        values.put(AccountTable.COL_HEIGHT,height);
